import {
  version
} from "./chunk-MGFNASII.js";
import {
  selectSvgElement
} from "./chunk-HZCH4I6V.js";
import {
  JSON_SCHEMA,
  load
...
import "./chunk-5FJQTPEU.js";
import "./chunk-YNRHT2NQ.js";
import "./chunk-6DRSCPFV.js";
import {
  registerIconPacks
} from "./chunk-WNDUGTV5.js";
import {
  dedent
} from "./chunk-SGKNDP7A.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-6F5ED5ID-MHWJ5O2F.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-7ASYPVHJ-OIBFJBWH.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-6RL3IURR-2SYRMMLS.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-NRZ2UAAF-HYGA7P5Z.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-NTVNEXSI-GPJSELLN.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-A4XQUW5V-JU5LRBX4.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-YF2LJOPJ-FUTL5APG.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-OS5C2QUG-IJHR2WCU.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-6QU3TZC5-EFPF74ZY.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-MIRIMTAZ-5CXZC555.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-G6AWOVSC-RHYHKSDX.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-LNE6IOMH-SRZUWMAL.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-MQ7JQ4JX-6TSFS47C.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-MAYHULR4-MYDBRH7V.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-4JROLMXI-YCALZE4S.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-G5WM74LC-H5CRMSFB.js");
...
var draw = __name((_text, id26, version2) => {
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-U7ZMHBDA-LTJ75K7X.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-GWI6TPTV-YEH5CVWY.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-QRCXZQQD-22OHFLS2.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-Y46BX6SQ-Z3EBD3HG.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-QW4FP2JN-FGYUIXIG.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-ZHA2E4KO-R77EATCX.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-UYN6MBPD-HKSDK4AX.js");
...
var appendDivSvgG = __name((parentRoot, id26, enclosingDivId, divStyle, svgXlink) => {
...
var removeExistingElements = __name((doc, id26, divId, iFrameId) => {
  var _a2, _b, _c;
  (_a2 = doc.getElementById(id26)) == null ? void 0 : _a2.remove();
  (_b = doc.getElementById(divId)) == null ? void 0 : _b.remove();
  (_c = doc.getElementById(iFrameId)) == null ? void 0 : _c.remove();
}, "removeExistingElements");
var render = __name(async function(id26, text, svgContainingElement) {
...
var render2 = __name((id26, text, container) => {
  return new Promise((resolve, reject) => {
    const performCall = __name(() => new Promise((res, rej) => {
