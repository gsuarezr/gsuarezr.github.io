...
var addRequirement = __name((name, type) => {
...
var getRequirements = __name(() => requirements, "getRequirements");
var setNewReqId = __name((id) => {
  if (latestRequirement !== void 0) {
    latestRequirement.id = id;
  }
}, "setNewReqId");
var setNewReqText = __name((text) => {
  if (latestRequirement !== void 0) {
    latestRequirement.text = text;
  }
}, "setNewReqText");
var setNewReqRisk = __name((risk) => {
  if (latestRequirement !== void 0) {
    latestRequirement.risk = risk;
  }
}, "setNewReqRisk");
var setNewReqVerifyMethod = __name((verifyMethod) => {
  if (latestRequirement !== void 0) {
    latestRequirement.verifyMethod = verifyMethod;
  }
}, "setNewReqVerifyMethod");
var addElement = __name((name) => {
...
var getElements = __name(() => elements, "getElements");
var setNewElementType = __name((type) => {
  if (latestElement !== void 0) {
    latestElement.type = type;
  }
}, "setNewElementType");
var setNewElementDocRef = __name((docRef) => {
  if (latestElement !== void 0) {
    latestElement.docRef = docRef;
  }
}, "setNewElementDocRef");
var addRelationship = __name((type, src, dst) => {
  relations.push({
    type,
    src,
    dst
...
var getRelationships = __name(() => relations, "getRelationships");
var clear2 = __name(() => {
  relations = [];
  latestRequirement = {};
...
var requirementDb_default = {
  ...
  VerifyType,
  Relationships,
  getConfig: __name(() => getConfig2().req, "getConfig"),
  addRequirement,
  getRequirements,
  setNewReqId,
  setNewReqText,
...
var insertLineEndings = __name((parentNode, conf2) => {
...
var conf = {};
var relCnt = 0;
var newRectNode = __name((parentNode, id) => {
...
var newTitleNode = __name((parentNode, id, txts) => {
...
var newBodyNode = __name((parentNode, id, txts, yStart) => {
...
var addEdgeLabel = __name((parentNode, svgPath, conf2, txt) => {
...
var drawRelationshipFromLayout = __name(function(svg, rel, g, insert, diagObj) {
...
var drawReqs = __name((reqs, graph, svgNode) => {
...
var drawElements = __name((els, graph, svgNode) => {
...
var addRelationships = __name((relationships, g) => {
...
var adjustEntities = __name(function(svgNode, graph) {
...
//# sourceMappingURL=requirementDiagram-MIRIMTAZ-5CXZC555.js.map
