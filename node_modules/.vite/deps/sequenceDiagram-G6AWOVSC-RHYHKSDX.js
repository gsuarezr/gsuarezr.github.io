...
var addBox = __name(function(data) {
...
var addActor = __name(function(id, name, description, type) {
...
var activationCount = __name((part) => {
  let i;
  let count = 0;
  if (!part) {
    return 0;
...
var addMessage = __name(function(idFrom, idTo, message, answer) {
...
var addSignal = __name(function(idFrom, idTo, message, messageType, activate = false) {
  ...
  state.records.messages.push({
    ...
    wrap: (message == null ? void 0 : message.wrap) ?? autoWrap(),
    type: messageType,
    activate
  });
  return true;
}, "addSignal");
var hasAtLeastOneBox = __name(function() {
  return state.records.boxes.length > 0;
}, "hasAtLeastOneBox");
var hasAtLeastOneBoxWithTitle = __name(function() {
  return state.records.boxes.some((b) => b.name);
}, "hasAtLeastOneBoxWithTitle");
var getMessages = __name(function() {
  return state.records.messages;
}, "getMessages");
var getBoxes = __name(function() {
  return state.records.boxes;
}, "getBoxes");
var getActors = __name(function() {
  return state.records.actors;
}, "getActors");
var getCreatedActors = __name(function() {
  return state.records.createdActors;
}, "getCreatedActors");
var getDestroyedActors = __name(function() {
  return state.records.destroyedActors;
}, "getDestroyedActors");
var getActor = __name(function(id) {
  return state.records.actors.get(id);
}, "getActor");
var getActorKeys = __name(function() {
  return [...state.records.actors.keys()];
}, "getActorKeys");
var enableSequenceNumbers = __name(function() {
  state.records.sequenceNumbersEnabled = true;
}, "enableSequenceNumbers");
var disableSequenceNumbers = __name(function() {
  state.records.sequenceNumbersEnabled = false;
}, "disableSequenceNumbers");
var showSequenceNumbers = __name(() => state.records.sequenceNumbersEnabled, "showSequenceNumbers");
var setWrap = __name(function(wrapSetting) {
  state.records.wrapEnabled = wrapSetting;
}, "setWrap");
var extractWrap = __name((text) => {
  if (text === void 0) {
    return {};
  }
  text = text.trim();
...
var autoWrap = __name(() => {
  ...
  return ((_a = getConfig2().sequence) == null ? void 0 : _a.wrap) ?? false;
}, "autoWrap");
var clear2 = __name(function() {
  state.reset();
  clear();
}, "clear");
var parseMessage = __name(function(str) {
...
var parseBoxData = __name(function(str) {
...
var addNote = __name(function(actor, placement, message) {
  const note = {
    actor,
    placement,
    message: message.text,
...
var addLinks = __name(function(actorId, text) {
...
var addALink = __name(function(actorId, text) {
  const actor = getActor(actorId);
  try {
    const links = {};
    let sanitizedText = sanitizeText(text.text, getConfig2());
...
var addProperties = __name(function(actorId, text) {
  const actor = getActor(actorId);
  try {
...
var addDetails = __name(function(actorId, text) {
  const actor = getActor(actorId);
...
var getActorProperty = __name(function(actor, key) {
  if ((actor == null ? void 0 : actor.properties) !== void 0) {
    return actor.properties[key];
  }
  return void 0;
}, "getActorProperty");
var apply = __name(function(param) {
...
var sequenceDb_default = {
  ...
  getDiagramTitle,
  setDiagramTitle,
  getConfig: __name(() => getConfig2().sequence, "getConfig"),
  clear: clear2,
  parseMessage,
  parseBoxData,
  LINETYPE,
...
var drawActorTypeParticipant = __name(function(elem, actor, conf2, isFooter) {
  ...
  var cssclass = "actor";
  if ((_a = actor.properties) == null ? void 0 : _a.class) {
...
//# sourceMappingURL=sequenceDiagram-G6AWOVSC-RHYHKSDX.js.map
