...
var splitClassNameAndType = __name(function(_id) {
...
var setClassLabel = __name(function(_id, label) {
  const id = common_default.sanitizeText(_id, getConfig2());
  if (label) {
...
var addClass = __name(function(_id) {
  const id = common_default.sanitizeText(_id, getConfig2());
...
var addInterface = __name(function(label, classId) {
...
var lookUpDomId = __name(function(_id) {
  const id = common_default.sanitizeText(_id, getConfig2());
  if (classes.has(id)) {
...
var getClass = __name(function(id) {
  return classes.get(id);
}, "getClass");
var getClasses = __name(function() {
  return classes;
}, "getClasses");
var getRelations = __name(function() {
  return relations;
}, "getRelations");
var getNotes = __name(function() {
  return notes;
}, "getNotes");
var addRelation = __name(function(classRelation) {
...
var addAnnotation = __name(function(className, annotation) {
  const validatedClassName = splitClassNameAndType(className).className;
  classes.get(validatedClassName).annotations.push(annotation);
}, "addAnnotation");
var addMember = __name(function(className, member) {
  addClass(className);
  const validatedClassName = splitClassNameAndType(className).className;
...
var addMembers = __name(function(className, members) {
  if (Array.isArray(members)) {
    members.reverse();
    members.forEach((member) => addMember(className, member));
  }
}, "addMembers");
var addNote = __name(function(text, className) {
  const note = {
...
var cleanupLabel = __name(function(label) {
  if (label.startsWith(":")) {
    label = label.substring(1);
  }
  return sanitizeText2(label.trim());
}, "cleanupLabel");
var setCssClass = __name(function(ids, className) {
...
var defineClass = __name(function(ids, style) {
  for (const id of ids) {
...
var getTooltip = __name(function(id, namespace) {
...
var setClickFunc = __name(function(_domId, functionName, functionArgs) {
...
functions.push(setupToolTips);
var direction = "TB";
var getDirection = __name(() => direction, "getDirection");
var setDirection = __name((dir) => {
  direction = dir;
}, "setDirection");
var addNamespace = __name(function(id) {
...
var getNamespace = __name(function(name) {
  return namespaces.get(name);
}, "getNamespace");
var getNamespaces = __name(function() {
  return namespaces;
}, "getNamespaces");
var addClassesToNamespace = __name(function(id, classNames) {
  if (!namespaces.has(id)) {
    return;
  }
...
var setCssStyle = __name(function(id, styles) {
...
var getData = __name(() => {
  ...
  for (const note of notes) {
    ...
    nodes.push(noteNode);
    const noteClassId = ((_a2 = classes.get(note.class)) == null ? void 0 : _a2.id) ?? "";
    if (noteClassId) {
      const edge = {
        id: `edgeNote${cnt}`,
        start: note.id,
...
var classDb_default = {
  ...
  getAccDescription,
  setAccDescription,
  getConfig: __name(() => getConfig2().class, "getConfig"),
  addClass,
  bindFunctions,
  clear: clear2,
  getClass,
...
//# sourceMappingURL=chunk-4BBKLDBI.js.map
