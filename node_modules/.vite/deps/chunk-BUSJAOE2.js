...
var setupDoc = __name((parentParsedItem, doc, diagramStates, nodes2, edges2, altFlag, look, classes2) => {
  log.trace("items", doc);
  doc.forEach((item) => {
    switch (item.stmt) {
      case STMT_STATE:
...
function getClassesFromDbInfo(dbInfoItem) {
  var _a;
  return ((_a = dbInfoItem == null ? void 0 : dbInfoItem.classes) == null ? void 0 : _a.join(" ")) ?? "";
}
...
var dataFetcher = __name((parent, parsedItem, diagramStates, nodes2, edges2, altFlag, look, classes2) => {
  var _a, _b;
  ...
  if (itemId !== "root") {
    ...
    if (parsedItem.description) {
      if (Array.isArray(newNode.description)) {
        ...
        if (((_a = newNode.description) == null ? void 0 : _a.length) > 0) {
          newNode.shape = SHAPE_STATE_WITH_DESC;
...
var setRootDoc = __name((o) => {
  log.info("Setting root doc", o);
  rootDoc = o;
}, "setRootDoc");
var getRootDoc = __name(() => rootDoc, "getRootDoc");
var docTranslator = __name((parent, node, first) => {
...
var getRootDocV2 = __name(() => {
  docTranslator({ id: "root" }, { id: "root", doc: rootDoc }, true);
  return { id: "root", doc: rootDoc };
}, "getRootDocV2");
var extract = __name((_doc) => {
  let doc;
  if (_doc.doc) {
    doc = _doc.doc;
  } else {
      ...
      case STMT_STYLEDEF:
        {
          ...
          ids.forEach((id) => {
            ...
            foundState.styles = styles.map((s) => {
              var _a;
              return (_a = s.replace(/;/g, "")) == null ? void 0 : _a.trim();
            });
          });
        }
        break;
...
var addState = __name(function(id, type = DEFAULT_STATE_TYPE, doc = null, descr = null, note = null, classes2 = null, styles = null, textStyles = null) {
...
var clear2 = __name(function(saveCommon) {
  nodes = [];
  edges = [];
  documents = {
    root: newDoc()
...
var getState = __name(function(id) {
  return currentDocument.states.get(id);
}, "getState");
var getStates = __name(function() {
  return currentDocument.states;
}, "getStates");
var logDocuments = __name(function() {
...
var addRelation = __name(function(item1, item2, title) {
...
var addDescription = __name(function(id, descr) {
...
var getClasses2 = __name(function() {
  return classes;
}, "getClasses");
...
var setStyle = __name(function(itemId, styleText) {
  const item = getState(itemId);
  if (item !== void 0) {
    item.styles.push(styleText);
  }
}, "setStyle");
var setTextStyle = __name(function(itemId, cssClassName) {
  const item = getState(itemId);
  if (item !== void 0) {
...
var trimColon = __name((str) => str && str[0] === ":" ? str.substr(1).trim() : str.trim(), "trimColon");
var getData = __name(() => {
  const config = getConfig2();
  return { nodes, edges, other: {}, config, direction: getDir(getRootDocV2()) };
}, "getData");
var stateDb_default = {
  getConfig: __name(() => getConfig2().state, "getConfig"),
  getData,
  addState,
  clear: clear2,
  getState,
...
//# sourceMappingURL=chunk-BUSJAOE2.js.map
