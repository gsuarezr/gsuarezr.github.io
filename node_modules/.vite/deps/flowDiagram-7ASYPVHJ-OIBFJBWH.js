import {
  getDiagramElement,
  setupViewPortForSVG
} from "./chunk-O3C7AHV5.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-KV7ZYB7Y.js";
import {
  getRegisteredLayoutAlgorithm,
  render
} from "./chunk-GNE2BQXN.js";
import "./chunk-BA42B2WP.js";
import {
  isValidShape
} from "./chunk-5FJQTPEU.js";
import "./chunk-YNRHT2NQ.js";
import "./chunk-6DRSCPFV.js";
import "./chunk-WNDUGTV5.js";
import "./chunk-SGKNDP7A.js";
import {
  getEdgeId,
  utils_default
} from "./chunk-HFPHGEHX.js";
import "./chunk-22NW4LQD.js";
import {
  __name,
  channel_default,
  clear,
  ...
  setConfig2,
  setDiagramTitle
} from "./chunk-XXM3VLFD.js";
import {
  select_default
} from "./chunk-Q6ZA7OPA.js";
...
var version;
var funs = [];
var sanitizeText = __name((txt) => common_default.sanitizeText(txt, config), "sanitizeText");
var lookUpDomId = __name(function(id) {
...
var addVertex = __name(function(id, textObj, type, style, classes2, dir, props = {}, shapeData) {
  var _a, _b;
  ...
  if (shapeData !== void 0) {
    ...
    if (doc == null ? void 0 : doc.icon) {
      ...
      if (!((_a = doc.label) == null ? void 0 : _a.trim()) && vertex.text === id) {
        vertex.text = "";
      }
    }
...
var addSingleLink = __name(function(_start, _end, type) {
  const start = _start;
  const end = _end;
...
var addLink = __name(function(_start, _end, type) {
...
var updateLinkInterpolate = __name(function(positions, interpolate) {
...
var updateLink = __name(function(positions, style) {
  positions.forEach(function(pos) {
    ...
    if (pos === "default") {
      ...
      if ((((_b = (_a = edges[pos]) == null ? void 0 : _a.style) == null ? void 0 : _b.length) ?? 0) > 0 && !((_d = (_c = edges[pos]) == null ? void 0 : _c.style) == null ? void 0 : _d.some((s) => s == null ? void 0 : s.startsWith("fill")))) {
        (_f = (_e = edges[pos]) == null ? void 0 : _e.style) == null ? void 0 : _f.push("fill:none");
      }
    }
  });
}, "updateLink");
var addClass = __name(function(ids, style) {
...
var setTooltip = __name(function(ids, tooltip) {
  if (tooltip === void 0) {
    return;
  }
...
var setLink = __name(function(ids, linkStr, target) {
  ids.split(",").forEach(function(id) {
    const vertex = vertices.get(id);
    if (vertex !== void 0) {
...
var getTooltip = __name(function(id) {
...
var getVertices = __name(function() {
  return vertices;
}, "getVertices");
var getEdges = __name(function() {
  return edges;
}, "getEdges");
var getClasses = __name(function() {
  return classes;
}, "getClasses");
var setupToolTips = __name(function(element) {
  ...
  nodes.on("mouseover", function() {
    ...
    const rect = this == null ? void 0 : this.getBoundingClientRect();
...
var clear2 = __name(function(ver = "gen-1") {
...
var setGen = __name((ver) => {
  version = ver || "gen-2";
}, "setGen");
var defaultStyle = __name(function() {
  return "fill:#ffa;stroke: #f66; stroke-width: 3px; stroke-dasharray: 5, 5;fill:#ffa;stroke: #666;";
}, "defaultStyle");
var addSubGraph = __name(function(_id, list, _title) {
...
var getPosForId = __name(function(id) {
...
var secCount = -1;
var posCrossRef = [];
var indexNodes2 = __name(function(id, pos) {
...
var getDepthFirstPos = __name(function(pos) {
  return posCrossRef[pos];
}, "getDepthFirstPos");
var indexNodes = __name(function() {
  secCount = -1;
  if (subGraphs.length > 0) {
    indexNodes2("none", subGraphs.length - 1);
  }
}, "indexNodes");
var getSubGraphs = __name(function() {
  return subGraphs;
}, "getSubGraphs");
var firstGraph = __name(() => {
  if (firstGraphFlag) {
...
var destructStartLink = __name((_str) => {
  let str = _str.trim();
  let type = "arrow_open";
  switch (str[0]) {
    case "<":
...
var destructEndLink = __name((_str) => {
  const str = _str.trim();
...
var destructLink = __name((_str, _startStr) => {
...
var makeUniq = __name((sg, allSubgraphs) => {
  const res = [];
...
var getTypeFromVertex = __name((vertex) => {
  if (vertex.img) {
    return "imageSquare";
  }
  if (vertex.icon) {
...
var findNode = __name((nodes, id) => nodes.find((node) => node.id === id), "findNode");
var destructEdgeType = __name((type) => {
...
var addNodeFromVertex = __name((vertex, nodes, parentDB, subGraphDB, config2, look) => {
  var _a;
  ...
  if (node) {
    ...
    const baseNode = {
      ...
      labelStyle: "",
      parentId,
      padding: ((_a = config2.flowchart) == null ? void 0 : _a.padding) || 8,
...
var getData = __name(() => {
  ...
  e.forEach((rawEdge, index) => {
    ...
    const edge = {
      ...
      arrowTypeStart: (rawEdge == null ? void 0 : rawEdge.stroke) === "invisible" ? "none" : arrowTypeStart,
      arrowTypeEnd: (rawEdge == null ? void 0 : rawEdge.stroke) === "invisible" ? "none" : arrowTypeEnd,
...
var flowDb_default = {
  defaultConfig: __name(() => defaultConfig2.flowchart, "defaultConfig"),
  setAccTitle,
  getAccTitle,
  getAccDescription,
  getData,
...
var getClasses2 = __name(function(text, diagramObj) {
...
var draw = __name(async function(text, id, _version, diag) {
  ...
  const padding = ((_a = data4Layout.config.flowchart) == null ? void 0 : _a.diagramPadding) ?? 8;
...
//# sourceMappingURL=flowDiagram-7ASYPVHJ-OIBFJBWH.js.map
