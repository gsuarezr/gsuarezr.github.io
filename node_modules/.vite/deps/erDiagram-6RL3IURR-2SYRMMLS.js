...
var addEntity = __name(function(name, alias = void 0) {
...
var getEntities = __name(() => entities, "getEntities");
var addAttributes = __name(function(entityName, attribs) {
...
var addRelationship = __name(function(entA, rolA, entB, rSpec) {
  let rel = {
    entityA: entA,
    roleA: rolA,
    entityB: entB,
...
var getRelationships = __name(() => relationships, "getRelationships");
...
var erDb_default = {
  Cardinality,
  Identification,
  getConfig: __name(() => getConfig2().er, "getConfig"),
  addEntity,
  addAttributes,
  getEntities,
  addRelationship,
...
var insertMarkers = __name(function(elem, conf2) {
  let marker;
...
var drawAttributes = __name((groupNode, entityTextNode, attributes) => {
...
var drawEntities = __name(function(svgNode, entities2, graph) {
...
var getEdgeName = __name(function(rel) {
  return (rel.entityA + rel.roleA + rel.entityB).replace(/\s/g, "");
}, "getEdgeName");
var addRelationships = __name(function(relationships2, g) {
...
//# sourceMappingURL=erDiagram-6RL3IURR-2SYRMMLS.js.map
